...
namespace Web_CinemaManagement.Models.ModelLinq
{
    ...
    partial void DeleteTHELOAIPHIM(THELOAIPHIM instance);
		...
		public System.Data.Linq.Table<CSKH> CSKHs
		{
			get
			{
				return this.GetTable<CSKH>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CSKH")]
	public partial class CSKH : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnCreated();
    partial void OnMaCSKHChanging(int value);
    partial void OnMaCSKHChanged();
    ...
    partial void OnNgayXuLyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaCSKH", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MaCSKH
		{
			get
			{
			...
			set
			{
				if ((this._MaCSKH != value))
				{
					this.OnMaCSKHChanging(value);
					this.SendPropertyChanging();
					this._MaCSKH = value;
					this.SendPropertyChanged("MaCSKH");
					this.OnMaCSKHChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LoaiVanDe", DbType="NVarChar(100)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PhanHoi", DbType="NVarChar(MAX)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KHACHHANG_CSKH", Storage="_KHACHHANG", ThisKey="MaKH", OtherKey="MAKH", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._KHACHHANG.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CSKHs.Remove(this);
					}
					this._KHACHHANG.Entity = value;
					if ((value != null))
					{
						value.CSKHs.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHANVIEN_CSKH", Storage="_NHANVIEN", ThisKey="MaNV", OtherKey="MANV", IsForeignKey=true)]
    ...
    partial void OnDIEMTICHLUYChanged();
		...
		public KHACHHANG()
		{
			this._CSKHs = new EntitySet<CSKH>(new Action<CSKH>(this.attach_CSKHs), new Action<CSKH>(this.detach_CSKHs));
			this._VEs = new EntitySet<VE>(new Action<VE>(this.attach_VEs), new Action<VE>(this.detach_VEs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KHACHHANG_CSKH", Storage="_CSKHs", ThisKey="MAKH", OtherKey="MaKH")]
		public EntitySet<CSKH> CSKHs
		{
			get
			{
				return this._CSKHs;
		...
		private void attach_CSKHs(CSKH entity)
		{
			this.SendPropertyChanging();
			entity.KHACHHANG = this;
		}
		
		private void detach_CSKHs(CSKH entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnMA_NQLChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHANVIEN_CSKH", Storage="_CSKHs", ThisKey="MANV", OtherKey="MaNV")]
		public EntitySet<CSKH> CSKHs
		{
			get
			{
